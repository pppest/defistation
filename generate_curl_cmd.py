...
for lp_contract in lp_list:
        ...
        token_bal =  float(dload.json(bscan_url+ lp_list[lp_contract] + addy_url + lp_contract )["result"])/10**18
        ...
        print(lp_list[lp_contract], token_bal, token_bnb_val, token_usd_val )
        print()
